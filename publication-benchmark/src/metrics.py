...
class RetrievalMetrics:
    recall_at_1: float  # R@1: % of queries where the first result is the gold paper
    recall_at_5: float  # R@5: % of queries with the gold paper in the top 5
    recall_at_10: float  # R@10: % of queries with the gold paper in the top 10
